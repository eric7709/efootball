...
import { useRegister } from "@/features/auth/hooks/api.auth";
...
export function UserSignup() {
  ...
  const update = <Key extends Exclude<keyof RegisterInput, "role">>(
    key: Key,
    ...
    <form className="panel grid auth-panel" onSubmit={handleSubmit}>
      <div>
        ...
        <p className="muted" style={{ margin: 0 }}>
          Set up your player account to compete in eFootball.
        </p>
      </div>
